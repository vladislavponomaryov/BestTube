...
export default function Sections({id}) {
    ...
    const channelID = id
    let playlists = useSelector(state => state.channel.playlists), sections = useSelector(state => state.channel.sections),
    ...
    let array = [
        {
            ...
            "snippet": {
                ...
                "description": "Lucasfilm’s official live stream, Star Wars Celebration LIVE! 2023 will feature select panels, along with celebrity guests on the LIVE! stage, and much more.",
                "thumbnails": {
                    "default": {
        ...
        },
        {
            ...
            "snippet": {
                ...
                "description": "This Week! in Star Wars is a weekly internet news show featuring a quick and snappy rundown of the week’s Star Wars news and tidbits, along with some special shout outs and historical factoids.",
                "thumbnails": {
                    "default": {
        ...
        },
        {
            ...
            "snippet": {
                ...
                "description": "The High Republic is set centuries prior to the events of Star Wars: The Phantom Menace, during the prime of the Jedi Order. The stories introduce new heroes to cheer on, new worlds to explore, and new threats to face.",
                "thumbnails": {
                    "default": {
        ...
        },
        {
            ...
            "snippet": {
                ...
                "channelId": "UCZGYJFUizSax-yElQaFDp5Q",
                "title": "Andor",
                "description": "Starring Diego Luna as Cassian Andor and set five years prior to Rogue One: A Star Wars Story, Andor starts streaming September 21 with a three-episode premiere, only on Disney+.",
                "thumbnails": {
                    "default": {
        ...
        },
        {
            ...
            "snippet": {
                ...
                "description": "Obi-Wan Kenobi follows Ewan McGregor’s legendary Jedi Master 10 years after the events of Star Wars: Revenge of the Sith. The Empire reigns and the few surviving Jedi are in hiding, with Kenobi living in secret on Tatooine and watching over Luke Skywalker from afar.",
                "thumbnails": {
                    "default": {
        ...
        },
        {
            ...
            "snippet": {
                ...
                "description": "The Book of Boba Fett, a thrilling Star Wars adventure, finds legendary bounty hunter Boba Fett and mercenary Fennec Shand navigating the galaxy’s underworld when they return to the sands of Tatooine to stake their claim on the territory once ruled by Jabba the Hutt and his crime syndicate.\n\nThe Book of Boba Fett stars Temuera Morrison and Ming-Na Wen. Jon Favreau, Dave Filoni, Robert Rodriguez, Kathleen Kennedy, and Colin Wilson are the executive producers. Karen Gilchrist and Carrie Beck serve as co-executive producers, with John Bartnicki producing and John Hampian as co-producer.",
                "thumbnails": {
                    "default": {
    ...
    if (fullPlaylist) {
        sectionsItem = playlists ? playlists.map(playlist => {
